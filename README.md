...
| `console open [--path /rules] [--no-browser]` | Open Protect Labs in your browser. The browser uses its own sign-in, so the page shows the instance you last opened Protect Labs for from the Clerk Dashboard |
